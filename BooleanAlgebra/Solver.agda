...
∩-morphism : ∀ {n} (Γ : Env n) (vs vs′ : VS n) → ⟦ vs ∩ vs′ ⟧″ Γ ≈ ⟦ vs ⟧″ Γ ∧ ⟦ vs′ ⟧″ Γ
∩-morphism []      []       []        = sym (proj₁ C.∧-identity ⊤)
∩-morphism (γ ∷ Γ) (T ∷ vs) (T ∷ vs′) = refl ⟨ ∧-cong ⟩ ∩-morphism Γ vs vs′ ⟨ trans ⟩ lem₁ γ _ _
∩-morphism (γ ∷ Γ) (T ∷ vs) (F ∷ vs′) = refl ⟨ ∧-cong ⟩ ∩-morphism Γ vs vs′ ⟨ trans ⟩ sym (∧-assoc _ _ _)
∩-morphism (γ ∷ Γ) (T ∷ vs) (N ∷ vs′) =                 ∩-morphism Γ vs vs′ ⟨ trans ⟩ lem₂ γ _ _
∩-morphism (γ ∷ Γ) (N ∷ vs) (T ∷ vs′) =                 ∩-morphism Γ vs vs′ ⟨ trans ⟩ lem₃ γ _ _
∩-morphism (γ ∷ Γ) (N ∷ vs) (N ∷ vs′) = refl ⟨ ∧-cong ⟩ ∩-morphism Γ vs vs′ ⟨ trans ⟩ lem₁ (¬ γ) _ _ 
∩-morphism (γ ∷ Γ) (N ∷ vs) (F ∷ vs′) = refl ⟨ ∧-cong ⟩ ∩-morphism Γ vs vs′ ⟨ trans ⟩ sym (∧-assoc _ _ _)
∩-morphism (γ ∷ Γ) (F ∷ vs) (T ∷ vs′) = refl ⟨ ∧-cong ⟩ ∩-morphism Γ vs vs′ ⟨ trans ⟩ lem₄ γ _ _
∩-morphism (γ ∷ Γ) (F ∷ vs) (N ∷ vs′) = refl ⟨ ∧-cong ⟩ ∩-morphism Γ vs vs′ ⟨ trans ⟩ lem₄ (¬ γ) _ _ 
∩-morphism (γ ∷ Γ) (F ∷ vs) (F ∷ vs′) =                 ∩-morphism Γ vs vs′
...
and-morphism Γ (m ∷ ms) m₂ = proj₂ ∧-∨-distrib (⟦ m₂ ⟧′ Γ) (⟦ m ⟧″ Γ) (⟦ ms ⟧′ Γ) 
                           ...
                           ⟨ trans ⟩ ++-morphism Γ (m₂ >>= λ t → [ m ∩ t ]) (ms >>= λ t₁ → m₂ >>= λ t₂ → [ t₁ ∩ t₂ ])
